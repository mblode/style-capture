...
const TermsPage = (): React.JSX.Element => (
  <article className="prose mx-auto max-w-3xl px-4 py-6 md:py-10">
    ...
    <p>
      We are MATTHEW & RONI BLODE PTY LTD (&apos;Company&apos;, &apos;we&apos;,
      &apos;us&apos;, or &apos;our&apos;), a company registered in Australia at
      22-24 Horne St, Elsternwick, Victoria 3185.
    </p>
    ...
    <p>
      ...
      &apos;Extension&apos;), as well as any other related products and services
      that refer or link to these legal terms (the &apos;Legal Terms&apos;)
      (collectively, the &apos;Services&apos;).
    </p>

    <p>
      You can contact us by email at <a href="mailto:m@blode.co">m@blode.co</a>,
      or by mail to 22-24 Horne St, Elsternwick, Victoria 3185, Australia.
    </p>
    ...
    <p>
      ...
      non-exclusive, non-transferable, revocable licence to access the Services
      and download or print a copy of any portion of the Content to which you
    ...
    <p>
      ...
      and licence to host, use, copy, reproduce, disclose, sell, resell,
      ...
      part), and distribute such Contributions for any purpose, commercial,
    ...
    <p>
      ...
      Legal Terms; (3) refuse, restrict access to, limit the availability of, or
    ...
    <p>
      ...
      at <Link href="/privacy">style-capture.blode.co/privacy</Link>. By using
    ...
    <p>
      ...
      that the courts of Australia shall have exclusive jurisdiction to resolve
