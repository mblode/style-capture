  ...
  <article className="prose mx-auto max-w-3xl px-4 py-6 md:py-10">
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          Use our Chrome extension, Style Capture, which processes data locally
          on your device
        </li>
        <li>
      ...
      <p>
        ...
        contact us at{" "}
        <a href="mailto:m@blode.co" rel="noopener noreferrer" target="_blank">
          m@blode.co
        </a>
        .
      </p>
      ...
      <p>
        ...
        <em>
          The Style Capture Chrome extension processes all data locally on your
          device. No captured data is transmitted to any server.
        </em>
      </p>

      <p>
        The Style Capture Chrome extension captures computed CSS styles and DOM
        structure from web pages you choose to inspect. This data is processed
        entirely on your device and is only copied to your clipboard at your
        request. We do not collect, transmit, or store any data captured by the
        extension. The extension uses only the <code>activeTab</code>,{" "}
        <code>scripting</code>, and <code>storage</code> permissions, and does
        not declare any host permissions.
      </p>
      ...
      <ul>
        <li>
          <strong>To respond to user inquiries and provide support.</strong> We
          may process your information to respond to your inquiries and provide
          support for the extension and related services.
        </li>
      </ul>
      ...
      <p>
        ...
        <em>
          ...
          provide you with services, to protect your rights, or to fulfil our
      ...
      <p>
        ...
        structured prompts designed for use with AI assistants. This formatting
        happens entirely on your device. We do not send any captured data to AI
        services — the formatted prompt is copied to your clipboard for you to
        use as you choose.
      </p>
      ...
      <p>
        ...
        Florida, Indiana, Iowa, Kentucky, Montana, Nebraska, New Hampshire, New
        Jersey, Oregon, Tennessee, Texas, Utah, or Virginia, you may have
        specific rights regarding your personal information. Please contact us
        at <a href="mailto:m@blode.co">m@blode.co</a> to exercise these rights.
      </p>
      ...
      <p>
        ...
        <a href="mailto:m@blode.co">m@blode.co</a> or contact us by post at:
      </p>
      ...
      <p>
        ...
        correct inaccuracies, or delete your personal information. To make such
