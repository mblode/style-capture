...
- Vite 7 + [CRXJS](https://crxjs.dev/vite-plugin/) for HMR
...
3. Click the Live CSS toolbar icon to open the popup

## Usage

1. Open the popup and click **Pick element**
2. Hover over elements on the active tab — the picker highlights the DOM subtree
3. Click to capture the computed CSS
4. View results in the results page (auto-opens or accessible from the popup)
5. Copy the Claude-ready markdown export when you want to hand the capture to Claude Code or another agent
...
- Results expose a structured markdown export with HTML, CSS, and Tailwind hints as the primary handoff format for agent workflows
